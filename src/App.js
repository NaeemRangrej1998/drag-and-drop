...
import Columns from "./dragAndDrop/Columns";
import MovableItems from "./dragAndDrop/MovableItems";
const App = () => {
    ...
    return (
            <div className="container">
                ...
                {/*    </Column>*/}
                {/*))}*/}
                <Columns title={COLUMN_NAMES.DO_IT} className="column do-it-column">
                    {returnItemsForColumn(COLUMN_NAMES.DO_IT)}
                </Columns>
                <Columns title={COLUMN_NAMES.IN_PROGRESS} className="column in-progress-column">
                    {returnItemsForColumn(COLUMN_NAMES.IN_PROGRESS)}
                </Columns>
                <Columns title={COLUMN_NAMES.AWAITING_REVIEW} className="column awaiting-review-column">
                    {returnItemsForColumn(COLUMN_NAMES.AWAITING_REVIEW)}
                </Columns>
                <Columns title={COLUMN_NAMES.DONE} className="column done-column">
